...
import 'package:food_fun/ui/child_screen.dart';
import 'package:food_fun/ui/child_servings.dart';
import 'package:food_fun/ui/discover.dart';
import 'package:food_fun/ui/disvover_item.dart';
...
import 'package:food_fun/ui/tracker.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        ...
        } else if (settings.name == "parent_dashboard") {
          return MaterialPageRoute(
              builder: (context) => const ParentDashboard());
        } else if (settings.name == "child_servings") {
          return MaterialPageRoute(builder: (context) => const ChildServings());
        } else if (settings.name == "discover_item") {
          return MaterialPageRoute(builder: (context) => const DiscoverItem());
        } else if (settings.name == "child_screen") {
          return MaterialPageRoute(builder: (context) => const ChildScreen());
        } else if (settings.name == "discover") {
          return MaterialPageRoute(builder: (context) => const Discover());
        }else if (settings.name == "tracker") {
          return MaterialPageRoute(builder: (context) => const Tracker());
        }
      },
      theme: ThemeData(
